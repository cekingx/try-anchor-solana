import { Program, workspace, web3, Wallet, AnchorProvider, setProvider } from "@coral-xyz/anchor";
...
async function main() {
  ...
  const storageAccount = new PublicKey('HVkQCFfSwaHQVYuTtNTTYmFGoiBcQkm8HSMDPa9Ma92Y')
  const result = await program.account.storage.fetch(storageAccount)
